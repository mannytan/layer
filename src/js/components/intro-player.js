...
if ( typeof AFRAME !== 'undefined' && AFRAME ) {
	AFRAME.registerComponent( 'intro-player', {
		...
		removeDirections () {
			this.el.removeChild( this.lookUp );
			this.el.removeChild( this.lookDown );
			this.el.removeChild( this.turnRight );
			this.el.removeChild( this.turnLeft );
			this.el.removeChild( this.turnAround );
		},
		...
		addDirections () {
			...
			this.lookUp = createText( 'L O O K   U P' );
			this.lookUp.setAttribute( 'position', '5.00 0.0 5.0' );
			this.lookUp.setAttribute( 'rotation', '-90 0 0' );
			this.el.appendChild( this.lookUp );

			this.lookDown = createText( 'L O O K   D O W N' );
			this.lookDown.setAttribute( 'position', '5.00 3.6 5.0' );
			this.lookDown.setAttribute( 'rotation', '90 0 0' );
			this.el.appendChild( this.lookDown );

			this.turnRight = createText( 'T U R N   R I G H T' );
			this.turnRight.setAttribute( 'position', '3.0 1.6 5.0' );
			this.turnRight.setAttribute( 'rotation', '0 90 0' );
			this.el.appendChild( this.turnRight );

			this.turnLeft = createText( 'T U R N   L E F T' );
			this.turnLeft.setAttribute( 'position', '7.0 1.6 5.0' );
			this.turnLeft.setAttribute( 'rotation', '0 -90 0' );
			this.el.appendChild( this.turnLeft );

			this.turnAround = createText( 'T U R N   A R O U N D' );
			this.turnAround.setAttribute( 'position', '5.00 1.6 7.0' );
			this.turnAround.setAttribute( 'rotation', '0 180 0' );
			this.el.appendChild( this.turnAround );
